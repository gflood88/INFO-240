...
This script has not been thoroughly vetted for a production environment.
...
$yourName = "Glenn Flood";

$yourEmail = "gflood88@gmail.com";

$requiredFields = "name,email,usability";

$defaultText = "Please submit your information below.";

$errorText = "Please check your entered data as there may be missing information and then submit again.";

$successText = "The form was successfully submitted. We will get back to within the next few business days.";
...
- View Source after submitting form to see additional classes in the confirm output
